...
class SentenceTransformerProvider(BaseEmbeddingProvider):
    ...
    def __init__(
        self, config: EmbeddingProviderConfig | None = None, model_name: str | None = None
    ):
    ...
    def encode_with_pooling(
        self, texts: str | list[str], pooling_strategy: str = "mean"
    ) -> np.ndarray:
        ...
        # TODO: Implement custom pooling strategies using pooling_strategy parameter
        _ = pooling_strategy  # Mark as intentionally unused for now
    ...
    def get_model_info(self) -> dict:
        ...
        if hasattr(self.model, "tokenizer"):
            info["tokenizer"] = {
                ...
                if hasattr(self.model.tokenizer, "__len__")
                else "unknown",
            }
    ...
    @classmethod
    def load_model(cls, path: str | Path) -> "SentenceTransformerProvider":
        ...
        config = EmbeddingProviderConfig(
            provider_type=EmbeddingProviderType.SENTENCE_TRANSFORMER, model_name=str(path)
        )
